import { RaceState, Track, Driver } from '../types/index.ts';
import { SeededRNG } from './rng.ts';
import { WeatherSystem } from './systems/WeatherSystem.ts';
import { PhysicsSystem } from './systems/PhysicsSystem.ts';
import { RaceLogicSystem } from './systems/RaceLogicSystem.ts';
import { StrategySystem } from './systems/StrategySystem.ts';
...
export class SimulationEngine {
  ...
  constructor(track: Track, drivers: Driver[], seed: number, gridOrder?: string[]) {
    this.track = track;
    ...
    // Initialize State
    this.state = this.raceLogicSystem.initializeRace(track, drivers, this.strategySystem, gridOrder);
