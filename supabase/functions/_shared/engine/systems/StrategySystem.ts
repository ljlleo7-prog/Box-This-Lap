import { VehicleState, Driver, RaceState, Track, StrategyPlan, StrategyStint, TyreCompound } from '../../types/index.ts';
import { TYRE_COMPOUNDS, TyreModel } from './TyreModel.ts';
