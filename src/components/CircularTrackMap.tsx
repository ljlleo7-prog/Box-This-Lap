...
export const CircularTrackMap: React.FC<CircularTrackMapProps> = ({ vehicles: externalVehicles, trackId: externalTrackId, title = 'Live Tracker', timeScale: _timeScale = 1 }) => {
    ...
    <div className="relative w-[300px] h-[300px] bg-neutral-900 rounded-xl border border-neutral-800 flex items-center justify-center shadow-lg">
      ...
      <svg width="300" height="300" viewBox="0 0 300 300">
        ...
        {vehicles.map((vehicle) => {
          ...
          const distanceOnLap = normalizeDistance(vehicle.distanceOnLap, totalDistance);
